<template>
  <div class="success-page">
    <div class="success-container">
      ...
      <ul class="next-steps">
        <ul>Start by adding any advisors that need access in your <a href="/admin" target="_blank">firm admin page</a>.
        </ul>
        <ul>Manage clients in your <a href="/dashboard" target="_blank">dashboard</a>.
        </ul>
        <ul>Ensure that your account and payment information remain up-to-date to enjoy uninterrupted service on your
